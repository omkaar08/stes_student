  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
      ...
      <div className="relative mb-6">
        <div className="rounded-xl p-4 border-2" style={{ borderColor: '#024698' }}>
          <button
            type="button"
          ...
          >
            <div className="flex items-center gap-4 min-w-0">
              <div className="w-14 h-14 rounded-lg flex items-center justify-center flex-shrink-0 text-white" style={{ backgroundColor: '#024698' }}>
                <svg
                  className="w-7 h-7"
                  fill="none"
                  stroke="currentColor"
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4 min-w-0">
                      <div
                        ...
                        style={isSelected ? { backgroundColor: '#024698' } : {}}
                      >
                        <svg
      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5">
          <div className="text-xs text-gray-600 font-semibold mb-2 flex items-center gap-2">
            <UserCheck size={18} className="text-[#024698]" />
            Present
          </div>
          <div className="text-3xl font-extrabold text-[#024698]">
            {present}
          </div>
        </div>
